      ...
      return (
            <Fragment>
                <Navbar/>
                    ...
                    <form style = {{display:'flex', flexDirection:'column', justifyContent:'center',alignItems:'center',width:'100%'}} onSubmit={onSubmitHandler}>
                        ...
                        {/* date클릭할 때 고정 */}
                            ...
                            직원구분
                            <select multiple={false} onChange ={staffClassHandler} value ={staffClass}>  
                        {/*                         
                        ...
                        */}
                            ...
                            종료
                            <select multiple={false} onChange ={closeStatusHandler} value ={closeStatus}>   
                            </select>
