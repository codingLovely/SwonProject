...
app.post('/api/s010100050/modifyMember', upload.fields([{ name: 'idCardFile', maxCount: 3 }, { name: 'registCardFile', maxCount: 5 }]), (req, res) => {
    ...
    sql += ' WHERE EMP.NAME="' + dataName + '"  AND EMP.EMP_HP="' + dataEmpHp + '"';
...
app.post('/api/s010100050/detailModifyContracId', (req, res) => {
    ...
    connection.beginTransaction(function (error) {
        ...
        let modifySql = 'UPDATE TB_S10_EMP010 EMP ' +
            '   INNER JOIN TB_S10_MEMBER010 MEM ON EMP.EMP_ID = MEM.CEO_ID ' +
...
app.post('/api/s010100010/contractModify/dateChangeSt', (req, res) => {
